...
type ThemeId = 'dark' | 'paper' | 'elements' | 'military' | 'old-school' | 'cherry' | 'nostradamus' | 'big-boss' | 'university' | 'trip' | 'dark-side' | 'bauhaus';
...
function initialTheme(): ThemeId {
  try {
    ...
    return t === 'paper' || t === 'elements' || t === 'military' || t === 'old-school' || t === 'cherry' || t === 'nostradamus' || t === 'big-boss' || t === 'university' || t === 'trip' || t === 'dark-side' || t === 'bauhaus' ? t : 'elements';
  } catch {
    return 'elements';
  }
}
